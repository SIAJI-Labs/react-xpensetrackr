                                    ...
                                    <div className={ ` flex flex-row gap-1 w-full border p-1 rounded-md ${errorRecordDialog?.type ? ` !border-red-500` : ''}` } id={ `record_dialog-type` }>
                                        {(() => {
                                            ...
                                            ['income', 'transfer', 'expense'].map((value, index) => {
                                                recordType.push(
                                                    <div className={ ` w-full text-center py-1 rounded-sm cursor-pointer ${ valueRecordType === value ? `bg-primary ` : ` dark:!text-white dark:hover:!text-black !text-black hover:!text-primary-foreground`} text-primary-foreground hover:bg-primary/90 transition` } onClick={() => {
