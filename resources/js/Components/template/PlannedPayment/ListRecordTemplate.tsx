...
type PlannedPaymentListRecordTemplateProps = {
    plannedPayment?: any
}

export default function ListRecordTemplate({ plannedPayment }: PropsWithChildren<PlannedPaymentListRecordTemplateProps> ){
